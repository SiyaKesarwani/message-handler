...
from functionalities.concrete_agent import ConcreteAgent

def setUpTask():
    # Create message queues for both concrete agents
    inbox1 = Queue()
    outbox1 = Queue()
    inbox2 = Queue()
    outbox2 = Queue()
    ...
    # Instantiate agents
    agent1 = ConcreteAgent(inbox1, outbox1, "Agent 1")
    agent2 = ConcreteAgent(inbox2, outbox2, "Agent 2")
